...
function getHandle(nodeId, handleType, handleId, nodeLookup, withAbsolutePosition = false) {
  ...
  const handles = (_a = node.internals.handleBounds) == null ? void 0 : _a[handleType];
...
function EdgeUpdateAnchors({ isReconnectable, reconnectRadius, edge, targetHandleId, sourceHandleId, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, onReconnect, onReconnectStart, onReconnectEnd, setReconnecting, setUpdateHover }) {
  ...
  const handleEdgeUpdater = (event, isSourceHandle) => {
    ...
    const _onReconnectEnd = (evt, connectionState) => {
      ...
      onReconnectEnd == null ? void 0 : onReconnectEnd(evt, edge, handleType, connectionState);
    };
...
function BackgroundComponent({
  ...
  const scaledOffset = [offsetXY[0] * transform2[2] || 1, offsetXY[1] * transform2[2] || 1];
