import type { HandleType, XYPosition, Handle, NodeLookup } from '../types';
export declare function getClosestHandle(position: XYPosition, connectionRadius: number, nodeLookup: NodeLookup, fromHandle: {
    nodeId: string;
    type: HandleType;
    id?: string | null;
}): Handle | null;
export declare function getHandle(nodeId: string, handleType: HandleType, handleId: string | null, nodeLookup: NodeLookup, withAbsolutePosition?: boolean): Handle | null;
