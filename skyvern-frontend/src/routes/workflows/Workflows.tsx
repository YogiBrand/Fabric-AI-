    ...
    <div className="space-y-10">
      <div className="flex h-32 justify-between gap-6">
        <div className="space-y-5">
          <div className="flex items-center gap-2">
            <LightningBoltIcon className="size-7 text-primary" />
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border">
          <Table>
            <TableHeader className="rounded-t-lg bg-muted/50">
              <TableRow>
                <TableHead className="w-1/3 rounded-tl-lg text-muted-foreground">
                  ID
                </TableHead>
                <TableHead className="w-1/3 text-muted-foreground">Title</TableHead>
