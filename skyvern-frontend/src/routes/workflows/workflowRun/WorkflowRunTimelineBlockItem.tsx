...
function WorkflowRunTimelineBlockItem({
  ...
  return (
    <div
      className={cn(
        "cursor-pointer space-y-4 rounded border border-border bg-card p-4 shadow-md transition-all hover:shadow-lg",
        {
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-2">
            {showFailureIndicator && (
              <div className="self-start rounded bg-muted px-2 py-1">
            ...
            <div className="flex gap-1 self-start rounded bg-muted px-2 py-1">
              {showDiagnosticLink ? (
