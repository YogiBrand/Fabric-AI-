...
function WorkflowParametersPanel() {
  ...
  return (
    <div className="relative w-[25rem] rounded-xl border border-gray-200 bg-white p-5 shadow-xl">
      <div className="space-y-4">
        <header>
          <h1 className="text-lg text-gray-900">Parameters</h1>
            ...
            <section className="space-y-2">
              {workflowParameters.map((parameter) => {
                return (
                  <div
                    key={parameter.key}
                    className="flex items-center justify-between gap-2 rounded-md bg-gray-50 border border-gray-200 px-3 py-2"
                  >
