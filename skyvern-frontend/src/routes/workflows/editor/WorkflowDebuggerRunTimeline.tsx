...
function WorkflowDebuggerRunTimeline({
  ...
  if (!workflowRun || !workflowRunTimeline) {
    return (
      <div className="flex h-full w-full flex-col items-center justify-center rounded-xl bg-white border border-gray-200 shadow-sm p-12">
  ...
  return (
    <div className="w-full min-w-0 space-y-4 rounded bg-white border border-gray-200 shadow-sm p-4">
      <div className="grid w-full grid-cols-2 gap-2">
        <div className="flex items-center justify-center rounded bg-gray-50 border border-gray-200 px-4 py-3 text-xs">
