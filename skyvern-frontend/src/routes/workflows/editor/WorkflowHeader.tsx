...
function WorkflowHeader({
  ...
  return (
    <div
      className={cn(
        "flex h-full w-full justify-between rounded-xl bg-white border border-gray-200 shadow-sm px-6 py-5",
      )}
    >
      <div className="flex h-full items-center">
        <EditableNodeTitle
          ...
          value={title}
          titleClassName="text-3xl text-gray-900"
          inputClassName="text-3xl text-gray-900"
        />
      </div>
