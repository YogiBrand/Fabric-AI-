  ...
  return (
    <>
      ...
      <header className="!mt-0 flex h-[2.75rem] justify-between gap-2">
        ...
        >
          <div className="flex h-[2.75rem] w-[2.75rem] items-center justify-center rounded border border-gray-300 bg-gray-50">
          ...
          <div className="flex flex-col gap-1">
            ...
            />
            <span className="text-xs text-gray-600">{blockTitle}</span>
          </div>
        </div>
          ...
          {debugStore.isDebugMode && isDebuggable && (
            <button
              ...
              className={cn("rounded p-1 disabled:opacity-50", {
                "hover:bg-gray-100": !anyBlockIsPlaying,
              })}
            >
              {runBlock.isPending ? (
                <ReloadIcon className="size-6 animate-spin" />
