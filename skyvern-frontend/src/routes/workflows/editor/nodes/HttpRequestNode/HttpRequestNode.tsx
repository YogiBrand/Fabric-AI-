  ...
  return (
    <div>
      ...
      <Handle
        ...
        className="opacity-0"
      />
      <div className="w-[36rem] space-y-4 rounded-lg bg-white border border-gray-200 px-6 py-4 shadow-sm">
        <header className="flex h-[2.75rem] justify-between">
          <div className="flex gap-2">
            <div className="flex h-[2.75rem] w-[2.75rem] items-center justify-center rounded border border-gray-200">
              <WorkflowBlockIcon
            ...
            <div className="flex flex-col gap-1">
              ...
              />
              <span className="text-xs text-gray-600">HTTP Request Block</span>
            </div>
          </div>
          <div className="flex gap-2">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex gap-2">
                <Label className="text-xs text-gray-700">Headers</Label>
            ...
            <AccordionContent className="pl-6 pr-1 pt-1">
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  <div className="w-32 space-y-2">
                    <div className="flex gap-2">
                      <Label className="text-xs text-gray-700">Timeout</Label>
